...
#[proc_macro_derive(WindowManager)]
pub fn derive_window_manager(input: TokenStream) -> TokenStream {
    // let ast = parse_macro_input!(input as DeriveInput);
    // let ident = ast.ident;
    // quote!(
        // impl WindowManager for #ident {
        //     fn wm_aspect(
        //         &mut self,
        ...
        //         let cmd = format!("wm attributes {} {} ", self.path_name, attribute.to_string());
        //         match attribute {
